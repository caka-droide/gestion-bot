...
# ⚠️ À remplacer par l'ID réel du salon #avis-tickets (clic droit > Copier
# l'identifiant). Sert à poster les avis laissés par les demandeurs sur le
# staff qui a traité leur ticket. Peut aussi être surchargé par guild dans
# guild_settings.json comme les autres SALON_*.
SALON_AVIS_TICKETS_ID = 0
