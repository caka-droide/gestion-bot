...
class DataStore:
    ...
    def __init__(self, client: UpstashClient):
        ...
        self.invites: dict = {}
        self.giveaways: dict = {}
        # gw_settings : str(guild_id) -> {"min_invites": int, "bonus_percent": float}
        # Réglages persistants du système d'invitations pour les giveaways
        # (commande /gwinv). "bonus_percent" = points de % de chance gagnés
        # par invitation faite au-delà de "min_invites".
        self.gw_settings: dict = {}
        self.salon_pauses: dict = {}
        self.reglement: dict = {}
        self.role_menus: dict = {}
        self.avis: dict = {}
        # ── Avis sur le staff en fin de ticket ──────────────────────────────
        # tickets_info : str(channel_id) -> {guild_id, staff_id, staff_name,
        #   demandeur_id, ticket_nom} — rempli quand un staff accepte un
        #   ticket, lu/supprimé à la fermeture pour savoir qui noter et qui
        #   doit noter.
        self.tickets_info: dict = {}
        # avis_attente : str(message_id du DM envoyé au demandeur) -> mêmes
        #   champs que ci-dessus — permet de relier le clic sur une étoile
        #   (ou la soumission de la modale) à son contexte, y compris après
        #   un redémarrage du bot.
        self.avis_attente: dict = {}
        # avis_tickets : str(guild_id) -> liste de
        #   {staff_id, staff_name, note, texte, demandeur_id, ticket_nom} —
        #   historique complet, sert à calculer la moyenne par staff.
