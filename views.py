...
async def creer_salon_ticket(guild: discord.Guild, membre: discord.Member, raison: str = None,
                              staff_qui_accepte: discord.Member = None):
...
class TicketRequestView(discord.ui.View):
    ...
    async def accepter(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # On supprime la demande du salon "claim" une fois prise, au lieu de
        # juste désactiver les boutons : comme ça, les autres membres du staff
        # ne la voient plus du tout. Seul celui qui a cliqué reçoit une
        # confirmation privée (ephemeral), et l'action reste tracée dans les logs.
        try:
        ...
        await interaction.followup.send(
            f"✅ Tu as accepté cette demande : {ticket_channel.mention}", ephemeral=True
        )
